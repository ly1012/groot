...
import com.liyunx.groot.dataloader.fastjson2.deserializer.PostProcessorObjectReader;

/**
 * 后置处理器接口，需要保证线程安全，同一个对象可能会被多个线程共享
 *
...
@FunctionalInterface
public interface PostProcessor extends Processor, Validatable {
